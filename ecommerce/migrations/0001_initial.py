...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['product', 'user'], name='ecommerce_r_product_5f9978_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='saved_by', to='ecommerce.product')),
            ...
            options={
                'ordering': ['-saved_at'],
                'indexes': [models.Index(fields=['user', 'product'], name='ecommerce_s_user_id_b0e77e_idx')],
